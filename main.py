...
def testInsertionSort():
    ...
    plt.show()
    tot = np.array((size, totAvgRand, totAvgBack, totAvgOrd)).T
    np.savetxt("InsertionSort time table.csv", tot, fmt="%1.f,%1.3f,%1.3f,%1.3f",
               header="Size,Random Vector,Backwards Vector,Ordained Vector")
...
def testQuickSort():
    ...
    plt.xlabel("Input's dimension ")
    plt.show()
    tot = np.array((size, totAvgRand, totAvgBack, totAvgOrd, totAvgBest)).T
    np.savetxt("QuickSort time table.csv", tot, fmt="%1.f,%1.3f,%1.3f,%1.3f,%1.3f",
               header="Size,Random Vector,Backwards Vector,Ordained Vector,Best Case Vector")
